...
<table>
    <tr>
        <td><img style="margin-left:50%;height:325px;width:700px;" src = "img/jayant.jpg"></td>
    ...
    <tr>
        ...
        <td><img style="margin-left:50%;height:325px;width:700px;" src = "img/ananya.jpg"> </td>
    </tr>
    <tr>
        <td><img style="margin-left:50%;height:325px;width:700px;" src = "img/ujjwal.jpg"></td>
        <td>
    ...
    <td>
        <img style="margin-left:50%;height:325px;width:700px;" src = "img/Liyulu.png"> 
    </td>
    </tr>
</table>
...
<tr>
<td>
 <img src = "img/cat.jpg" style="height:130px;width:800px;">
 </td>
 <td>
