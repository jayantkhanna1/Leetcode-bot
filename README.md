...
<table>
    <tr>
        <td><img style="margin-left:50%;height:350px;" src = "img/jayant.jpg"></td>
    ...
    <tr>
        <td><img style="margin-left:50%;height:350px;margin-left:15px;" src = "img/ananya.jpg"> </td>
        <td><p style="text-align:center;">Ananya Vishnoi : She is helping me check all answers for LeetCode in C++ language and making them Bot compatible. She is also helping me in testing the bot. She is a great friend and a great coder. You can check her Github profile <a href = "https://github.com/ananya26-vishnoi">Here</a>
 </p></td>
    </tr>
</table>
